...
"")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("resx/Google-Noto-Emoji-Objects-62971-gear.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
...
"color: rgb(255, 255, 255);")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("resx/Oxygen-Icons.org-Oxygen-Apps-preferences-system-windows.ico"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
